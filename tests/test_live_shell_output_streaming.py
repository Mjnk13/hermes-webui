    ...
    with sync_playwright() as playwright:
        ...
        result = page.evaluate(
            """async () => {
              ...
              const childNodesWhileRunning = code.childNodes.length;
    ...
    with sync_playwright() as playwright:
        ...
        result = page.evaluate(
            """async () => {
              ...
              // A background/throttled browser renderer can defer the
              ...
              // Chromium can apply another compositor reset after the
